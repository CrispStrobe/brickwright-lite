/**
 * VENDORED from sb3-creator `test/helpers/timed.mjs`, 2026-08-23.
 *
 * Edit it there, not here. It is copied rather than imported because the two
 * repositories are cloned independently in CI and a cross-repo import would be
 * the exact skip-in-CI shape sb3-creator spent a campaign removing
