...
test('scope trigger finds the latest crossing in chronological ring-buffer order', () => {
...
test('scope window anchors the trigger with pre-trigger context', () => {
...
test('time cursors report delta from real sample cadence and selected window', () => {
