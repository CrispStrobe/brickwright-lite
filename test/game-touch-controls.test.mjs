...
const PUBLIC_GAMES = [
    'g2048', 'sigil_grid', 'vector_seven', 'reactor_ricochet', 'flux_vault', 'neon_circuit', 'canal_command', 'sky_skim', 'chroma_code', 'fusion_foundry', 'missile_ballet', 'orbit_ward',
...
test('touch profiles expose the controls each unusual game actually uses', () => {
    ...
    assert.equal(gameTouchProfileFor('canal_command').layout, 'stage');
