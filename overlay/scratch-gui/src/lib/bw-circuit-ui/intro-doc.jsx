...
// intro-doc.jsx is LITE-AUTHORED and lives inside a VENDORED root.
//
...
//
// WHY IT LIVES HERE:
// The extraction target for ExamplesBrowser.jsx's 115 upstream-only lines. It
// lives in the vendored root because the vendored component imports it by
// relative path ('../intro-doc.jsx'), and the whole point of the extraction
// was that the catalogue and the top bar's (i) share ONE parser -- two copies
// would be two truths.
//
// Imported by: components/ExamplesBrowser.jsx
