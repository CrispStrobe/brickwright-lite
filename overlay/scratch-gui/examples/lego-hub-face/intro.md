...
## Lego Hub Virtual Face

An abstracted virtual faceplate for a Spike Prime / Robot Inventor hub.
The controller panel shows what the hub's sensors and actuators are doing
— no physical hub needed.

- **5x5 light matrix** — the hub's LED grid, showing a rotating line
