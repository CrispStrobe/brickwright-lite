...
//
// Reads device state from vm.runtime.circuitBoard.getDeviceState(), same
// board attachment as the circuit extension.  Commands are forwarded to
// setDeviceControl() when the board supports it.
