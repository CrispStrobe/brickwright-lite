...
**T5. Fix what T2 surfaced.**
Depends: T2.
AVR `compile: true` (hosted), `flashFamily` comment and Mega routing
reconciled with `flasher.js`, `CHOOSING-HARDWARE.md` compile list corrected.
DoD: T2 green; the corrected cells render in T3's doc.
