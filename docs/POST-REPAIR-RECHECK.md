...
| — | engine motion: bw-board `b5c02b1` (vsource `rInternal`, PNP base junction, FET region extraction), `a301937` (buzzer KCL-visible), `88e96681` | every circuit lesson in waves 1·2·6·7 | landed AFTER every wave's "measured against" sha | **yes — every pinned number still holds** | re-derived: the whole lite suite at `eed6fcc73`, 993 pass / 0 fail / 1 skip. The ledger's shas are refreshed to say so |
