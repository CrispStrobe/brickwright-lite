...
are bw-ci's. Recorded because the list is more useful than any one fix.

## What is mechanised

`scripts/audit-gate-shapes.mjs` detects 3, 4, 5 and 9 across `test/` and `scripts/`. It blanks
...
measured 2026-09-02 — EVENT-AS-STATE 12, SEGMENT-MATCH 1, TRUNCATED-CAPTURE 8,
WINDOWED-SEARCH 37. Lower it as suspects are triaged; raising it to make a push green is the
