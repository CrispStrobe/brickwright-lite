...
export const attributePseudocodeImporter = input => {
    ...
    const deferredPayload = /(?:^|\/)src\/(?:components\/tw-pseudocode\/(?:pseudocode-importer\.jsx|brick-robot\.svg)|lib\/bw-asm\/examples(?:-i8086)?\.js|lib\/bw-matrix\/capabilities\.js|lib\/device-labels\.js)$/;
