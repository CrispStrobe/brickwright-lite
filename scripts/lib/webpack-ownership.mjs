...
export const P11_INITIAL_JAVASCRIPT_BYTES = 4552523;
...
export const summarizeWebpackOwnership = input => {
    ...
    return {
        ...
        lazyListMonitor: {
            ...
            initialReductionBytes: P11_INITIAL_JAVASCRIPT_BYTES -
...
export const assertLazyListMonitorBoundary = report => {
    ...
    if ((list?.initialReductionBytes || 0) < 75 * 1024) {
        failures.push(`initial JavaScript reduction from P11 fell below 75 KiB: ` +
