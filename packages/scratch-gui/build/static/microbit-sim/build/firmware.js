...
var _microbit_radio_rx_buffer = Module['_microbit_radio_rx_buffer'] = makeInvalidEarlyAccess('_microbit_radio_rx_buffer');
var _mp_js_request_stop = Module['_mp_js_request_stop'] = makeInvalidEarlyAccess('_mp_js_request_stop');
var _mp_js_force_stop = Module['_mp_js_force_stop'] = makeInvalidEarlyAccess('_mp_js_force_stop');
var _mp_js_main = Module['_mp_js_main'] = makeInvalidEarlyAccess('_mp_js_main');
var _malloc = makeInvalidEarlyAccess('_malloc');
var _free = makeInvalidEarlyAccess('_free');
var _microbit_hal_gesture_callback = Module['_microbit_hal_gesture_callback'] = makeInvalidEarlyAccess('_microbit_hal_gesture_callback');
var _microbit_hal_level_detector_callback = Module['_microbit_hal_level_detector_callback'] = makeInvalidEarlyAccess('_microbit_hal_level_detector_callback');
var _microbit_hal_audio_ready_callback = Module['_microbit_hal_audio_ready_callback'] = makeInvalidEarlyAccess('_microbit_hal_audio_ready_callback');
var _microbit_hal_audio_speech_ready_callback = Module['_microbit_hal_audio_speech_ready_callback'] = makeInvalidEarlyAccess('_microbit_hal_audio_speech_ready_callback');
...
function assignWasmExports(wasmExports) {
  assert(typeof wasmExports['microbit_radio_rx_buffer'] != 'undefined', 'missing Wasm export: microbit_radio_rx_buffer');
  assert(typeof wasmExports['mp_js_request_stop'] != 'undefined', 'missing Wasm export: mp_js_request_stop');
  assert(typeof wasmExports['mp_js_force_stop'] != 'undefined', 'missing Wasm export: mp_js_force_stop');
  assert(typeof wasmExports['mp_js_main'] != 'undefined', 'missing Wasm export: mp_js_main');
  assert(typeof wasmExports['malloc'] != 'undefined', 'missing Wasm export: malloc');
  assert(typeof wasmExports['free'] != 'undefined', 'missing Wasm export: free');
  assert(typeof wasmExports['microbit_hal_gesture_callback'] != 'undefined', 'missing Wasm export: microbit_hal_gesture_callback');
  assert(typeof wasmExports['microbit_hal_level_detector_callback'] != 'undefined', 'missing Wasm export: microbit_hal_level_detector_callback');
  assert(typeof wasmExports['microbit_hal_audio_ready_callback'] != 'undefined', 'missing Wasm export: microbit_hal_audio_ready_callback');
  assert(typeof wasmExports['microbit_hal_audio_speech_ready_callback'] != 'undefined', 'missing Wasm export: microbit_hal_audio_speech_ready_callback');
  ...
  _microbit_radio_rx_buffer = Module['_microbit_radio_rx_buffer'] = createExportWrapper('microbit_radio_rx_buffer', wasmExports['microbit_radio_rx_buffer'], 0);
  _mp_js_request_stop = Module['_mp_js_request_stop'] = createExportWrapper('mp_js_request_stop', wasmExports['mp_js_request_stop'], 0);
  _mp_js_force_stop = Module['_mp_js_force_stop'] = createExportWrapper('mp_js_force_stop', wasmExports['mp_js_force_stop'], 0);
  _mp_js_main = Module['_mp_js_main'] = createExportWrapper('mp_js_main', wasmExports['mp_js_main'], 1);
  _malloc = createExportWrapper('malloc', wasmExports['malloc'], 1);
  _free = createExportWrapper('free', wasmExports['free'], 1);
  _microbit_hal_gesture_callback = Module['_microbit_hal_gesture_callback'] = createExportWrapper('microbit_hal_gesture_callback', wasmExports['microbit_hal_gesture_callback'], 1);
  _microbit_hal_level_detector_callback = Module['_microbit_hal_level_detector_callback'] = createExportWrapper('microbit_hal_level_detector_callback', wasmExports['microbit_hal_level_detector_callback'], 1);
  _microbit_hal_audio_ready_callback = Module['_microbit_hal_audio_ready_callback'] = createExportWrapper('microbit_hal_audio_ready_callback', wasmExports['microbit_hal_audio_ready_callback'], 0);
  _microbit_hal_audio_speech_ready_callback = Module['_microbit_hal_audio_speech_ready_callback'] = createExportWrapper('microbit_hal_audio_speech_ready_callback', wasmExports['microbit_hal_audio_speech_ready_callback'], 0);
