"use strict";
(self["webpackChunkGUI"] = self["webpackChunkGUI"] || []).push([["src_lib_bw-board_rp2040js-adapter_js"],{

/***/ "./src/lib/bw-board/rp2040js-adapter.js":
/*!**********************************************!*\
  !*** ./src/lib/bw-board/rp2040js-adapter.js ***!
  \**********************************************/
...
/* harmony export */   RAM_START: () => (/* binding */ RAM_START),
/* harmony export */   RP2040_PINS: () => (/* binding */ RP2040_PINS),
/* harmony export */   createRp2040jsAdapter: () => (/* binding */ createRp2040jsAdapter)
/* harmony export */ });
/* harmony import */ var rp2040js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! rp2040js */ "./node_modules/rp2040js/dist/esm/index.js");
/**
...
const RP2040_PINS = {};
for (let i = 0; i <= 28; i++) RP2040_PINS["GP".concat(i)] = {
  index: i
};
/** GP26..GP28 carry ADC channels 0..2. */
for (let ch = 0; ch <= 2; ch++) RP2040_PINS["GP".concat(26 + ch)].adcChannel = ch;
 ...
 * }}
 */
function createRp2040jsAdapter() {
  var _opts$clockHz, _opts$vcc, _opts$sp;
  let opts = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  const clockHz = (_opts$clockHz = opts.clockHz) !== null && _opts$clockHz !== void 0 ? _opts$clockHz : 125000000;
  const vcc = (_opts$vcc = opts.vcc) !== null && _opts$vcc !== void 0 ? _opts$vcc : 3.3;
  ...
  const rp2040 = new rp2040js__WEBPACK_IMPORTED_MODULE_0__.RP2040();
  ...
  rp2040.logger = new rp2040js__WEBPACK_IMPORTED_MODULE_0__.ConsoleLogger(rp2040js__WEBPACK_IMPORTED_MODULE_0__.LogLevel.Error, false);
  let board = null;
  const stats = {
    pinChangeCount: 0,
    advanceToCount: 0,
  ...
  function publishPin(index, state) {
    ...
    const name = "GP".concat(index);
    switch (state) {
      case rp2040js__WEBPACK_IMPORTED_MODULE_0__.GPIOPinState.Low:
        board.setPin(name, 'pushpull', false);
        break;
      case rp2040js__WEBPACK_IMPORTED_MODULE_0__.GPIOPinState.High:
        board.setPin(name, 'pushpull', true);
        break;
      case rp2040js__WEBPACK_IMPORTED_MODULE_0__.GPIOPinState.InputPullUp:
        board.setPin(name, 'input-pullup', true);
        break;
      case rp2040js__WEBPACK_IMPORTED_MODULE_0__.GPIOPinState.InputPullDown:
  ...
  function syncInputs() {
    ...
    for (const def of Object.values(RP2040_PINS)) {
      ...
      pin.setInputValue(board.readPin("GP".concat(def.index)) === 1);
    }
  }
  ...
  rp2040.adc.onADCRead = channel => {
    ...
    if (channel <= 2 && board && board.readAnalog) {
      let volts = 0;
      try {
        var _board$readAnalog;
        volts = (_board$readAnalog = board.readAnalog("GP".concat(26 + channel))) !== null && _board$readAnalog !== void 0 ? _board$readAnalog : 0;
      } catch (_unused) {
        volts = 0;
      }
      rp2040.adc.channelValues[channel] = Math.max(0, Math.min(4095, Math.round(volts / vcc * 4095)));
    }
  ...
  let entrySP = (_opts$sp = opts.sp) !== null && _opts$sp !== void 0 ? _opts$sp : RAM_START + rp2040.sram.length;
  function loadProgram(halfwords) {
    let origin = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : RAM_START;
    ...
    advanceNs(deltaNs) {
      ...
      while (clock.nanos < target) {
        if (core.waiting) {
          ...
          const dt = toAlarm > 0 ? Math.min(toAlarm, target - clock.nanos) : target - clock.nanos;
          clock.tick(dt);
        } else {
