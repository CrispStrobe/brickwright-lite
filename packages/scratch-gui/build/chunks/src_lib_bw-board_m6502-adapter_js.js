"use strict";
(self["webpackChunkGUI"] = self["webpackChunkGUI"] || []).push([["src_lib_bw-board_m6502-adapter_js"],{

/***/ "./src/lib/bw-board/m6502-adapter.js":
/*!*******************************************!*\
  !*** ./src/lib/bw-board/m6502-adapter.js ***!
  \*******************************************/
...
/* harmony export */   createM6502Adapter: () => (/* binding */ createM6502Adapter)
/* harmony export */ });
/* harmony import */ var _m6502_machine_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./m6502-machine.js */ "./src/lib/bw-board/m6502-machine.js");
/* harmony import */ var _ps2_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ps2.js */ "./src/lib/bw-board/ps2.js");
 ...
 */
function createM6502Adapter() {
  var _opts$config;
  let opts = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  const config = (_opts$config = opts.config) !== null && _opts$config !== void 0 ? _opts$config : _m6502_machine_js__WEBPACK_IMPORTED_MODULE_0__.EATER6502;
  let board = null;
  const stats = {
    pinChangeCount: 0,
    advanceToCount: 0
  ...
  const machine = new _m6502_machine_js__WEBPACK_IMPORTED_MODULE_0__.M6502Machine(config, {
    ...
    for (const c of config.chips) {
      ...
      for (const [port, ddr] of [['a', via.ddra], ['b', via.ddrb]]) {
        for (let bit = 0; bit < 8; bit++) {
          ...
          const pin = "".concat(c.name, ".P").concat(port.toUpperCase()).concat(bit);
  ...
  function bridgePS2(b) {
    ...
    for (const part of b.parts) {
      ...
      const chipEntry = config.chips.find(c => c.kind === 'via' && (c.name === viaName || !viaName));
      if (!chipEntry) continue;
      const via = machine.chips[chipEntry.name];
      if (!via) continue;
      const cap = (0,_ps2_js__WEBPACK_IMPORTED_MODULE_1__.ps2OnVia)(state._kbd, via, {
        port,
        control
      });
  ...
  return {
    ...
    sendSerial(byte) {
      ...
      for (const chip of Object.values(machine.chips)) {
        ...
        if (chip && typeof chip.rxPush === 'function') {
          chip.rxPush(byte & 0xff);
          return true;
        }
        if (chip && Array.isArray(chip.rx)) {
          chip.rx.push(byte & 0xff);
          return true;
        }
      }
      return false;
