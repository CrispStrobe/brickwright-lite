...
class LibraryItemComponent extends React.PureComponent {
    render () {
        // Brickwright: extensions that ship only a small square icon (our bundled built-ins set
        // insetIconURL === iconURL; the fetched gallery sets no inset) get a centered, generously
        // sized icon instead of a stretched-tiny poster — and no redundant inset badge. Real posters
        // (a wide illustration + a distinct inset logo) keep the standard layout unchanged.
        const iconOnly = !this.props.insetIconURL || this.props.insetIconURL === this.props.iconURL;
            ...
            >
                <div
                    className={classNames(styles.featuredImageContainer, {
                        [styles.featuredImageContainerIconOnly]: iconOnly
                    })}
                >
                    {this.props.disabled ? (
                    ...
                    <img
                        className={classNames(styles.featuredImage, {
                            [styles.featuredImageIconOnly]: iconOnly
                        })}
                        src={this.props.iconURL}
                    />
                </div>
                {!iconOnly && this.props.insetIconURL ? (
