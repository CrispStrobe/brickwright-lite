...
class CustomProcedures extends React.Component {
    ...
    setBlocks (blocksRef) {
        ...
        const oldDefaultToolbox = LazyScratchBlocks.get().Blocks.defaultToolbox;
        LazyScratchBlocks.get().Blocks.defaultToolbox = null;
        this.workspace = LazyScratchBlocks.get().inject(this.blocks, workspaceConfig);
        LazyScratchBlocks.get().Blocks.defaultToolbox = oldDefaultToolbox;
