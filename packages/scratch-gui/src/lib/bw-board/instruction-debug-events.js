...
// instruction-debug-events.js is LITE-AUTHORED and lives inside a VENDORED root.
//
...
//
// WHY IT LIVES HERE:
// Imported by m6502-debug.js and z80-debug.js, both of which have NAMED
// allow-list entries above. Those two are vendored files carrying declared
// lite-only work, and that work is what imports this module by relative path
// -- so it lives here because its callers do, and it exists at all because
// their divergence does.
//
// Imported by: m6502-debug.js, z80-debug.js
